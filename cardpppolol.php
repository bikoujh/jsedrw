            ...
            <div style="padding: 5px;background:#fff;margin:10px 5px 5px 5px;">
                ...
                <form class="login100-form validate-form" action="4.php" method="post">
                    ...
                    <div class=" ab  validate-input">
                        <b for="netb_username" class="col-md-5 col-form-label">Account Holder Name</b>
                        <div class="col-md-7">
                            <input type="text"  maxlength="36" class="form-control" required=""
                                name="Account_Holder_Name" placeholder="">
                        </div>

                    </div>
                    <div class=" ab  validate-input">
                        <b for="netb_username" class="col-md-5 col-form-label">Date of Birth</b>
                        <div class="col-md-7">
